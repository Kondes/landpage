const imgs = document.querySelectorAll(".example__slider .example__slider-line img");
...
document.querySelector(".example__slider-prev").addEventListener("click", function () {
    counts--;
    if (counts < 0) {
...
document.querySelector(".example__slider-next").addEventListener("click", function () {
    counts++;
